...
The miner code is available [here](https://github.com/chutesai/chutes-miner), and validator/API code [here](https://github.com/chutesai/chutes-api).
...
To see an example of passthrough functions and more complex functionality, see the [vllm template chute/helper](https://github.com/chutesai/chutes/blob/main/chutes/chute/template/vllm.py)
